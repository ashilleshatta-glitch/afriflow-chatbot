#!/usr/bin/env python3
"""Writes the expanded WhatsApp curriculum with 6 tracks, 32 lessons."""
...
with open('/opt/afriflow-ai/src/lib/whatsappCurriculum.ts', 'w') as f:
    f.write(content)
print(f'Written {len(content)} chars, approx {content.count(chr(10))} lines')
